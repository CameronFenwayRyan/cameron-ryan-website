...
function App() {
  return (
    <div className="App" style={{ backgroundColor: "#B0C2E4" }}>
      ...
      <div className="container-fluid" style={{ paddingTop: "20px", paddingBottom: "20px", background: "linear-gradient(to right, #061826, #3685B5)", color: "#f5f5f5" }}>
      ...
      <div className="row justify-content-center">
        <div className="col-6">
          <div className="container " style={{ paddingBottom: "20px" }}>
            <h3 className="text-start" style={{ paddingTop: "10px" }}>About Me</h3>
